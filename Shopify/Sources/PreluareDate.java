...
public class PreluareDate {
    ...
    public static void implementEvents(String[] tokens)
    {
        ...
        else if(command.equals("getTotal"))
        {
            ...
            if(listOption.equalsIgnoreCase("shoppingcart"))
            {
                System.out.println(String.format("%.2f", Store.getInstance().getCustomers().get(customerName).shoppingCart.getTotalPrice()));
            }
            if(listOption.equalsIgnoreCase("wishlist"))
            {
                System.out.println(String.format("%.2f", Store.getInstance().getCustomers().get(customerName).wishList.getTotalPrice()));
            }
        }
